...
const ExploreIndia = () => {
  ...
  return (
    <>
    <div className='w-full hidden lg:block md:px-[100px] lg:px-20 2xl:px-[260px] lg:py-[50px]'>
        ...
        <div className="w-full lg:flex flex-col items-center relative px-4">
            ...
            <div className="absolute w-full px-4 lg:top-30 xl:top-50 z-50 shadow-none">
              <div className="relative w-full py-10">
                ...
                <div className="lg:hidden px-4 flex items-center justify-between w-full mb-6">
