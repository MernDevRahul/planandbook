...
const TeamOne = () => {
  return (
    <div>
      <h2 className="w-full text-center font-semibold text-(--primary) lg:my-6 text-[2vw] text-shadow-lg">
        Meet Our Team: The People Behind Every Beautiful Journey
      </h2>
      <div className="lg:px-[10vw] grid grid-cols-3 justify-items-center">
        <EmployeeCard
